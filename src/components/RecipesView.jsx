    ...
    <div style={{
      ...
      <div className="glass-card" style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>제품 및 레시피 설정을 편집하려면 로그인이 필요합니다.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ textAlign: 'left' }}>
          ...
          <div className="form-group" style={{ marginBottom: '16px' }}>
            <label htmlFor="admin-id" style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '6px', display: 'block' }}>관리자 아이디</label>
            <input
              type="text"
              id="admin-id"
          ...
          <div className="form-group" style={{ marginBottom: '24px' }}>
            <label htmlFor="admin-pw" style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)', marginBottom: '6px', display: 'block' }}>비밀번호</label>
            <input
              type="password"
              id="admin-pw"
              className="form-control"
...
const RecipesView = ({ 
  ...
  const { products, updateProduct, isAdminLoggedIn, loginAdmin, logoutAdmin } = useWysh();

  if (!isAdminLoggedIn) {
    return <AdminLoginForm onLogin={loginAdmin} />;
  }
      ...
      <div className="glass-card">
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button className="btn-secondary" onClick={logoutAdmin} style={{ padding: '6px 12px', fontSize: '0.8rem' }}>
              로그아웃
            </button>
