    ...
    // -------------------------------------------------------------
    {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            { term: '생산 제품 드롭다운', desc: '등록된 전체 제품 중 선택한 생산 구분(요구르트/부재료)에 부합하는 활성 제품 목록만 노출됩니다.' },
      ...
      content: [
        {
          ...
          items: [
            { term: '1단계: 발효 리포트 드롭다운', desc: '이번 주에 활성화된 요구르트 생산 계획 전체가 선택 가능하도록 드롭다운에 표출됩니다.' },
        ...
        },
        {
          ...
          items: [
            ...
            { term: '밧드 개수 & 마지막 밧드 무게', desc: '추출 밧드 수와 마지막 밧드의 무게(g)를 입력하면 총 유청 요구르트 무게(g)와 유청 로스율(Loss Rate %)이 자동 계산됩니다.' },
        ...
        },
        {
          ...
          items: [
            { term: '목표 수율 (Target Yield %)', desc: '플레이버 제품 생산 시 베이스 요구르트의 목표 수율(예: 28%)이 자동으로 적용되어 수율 목표치로 설정됩니다.' },
            { term: '실제 수율 (Actual Yield %)', desc: '플레이버 제품 생산 시 요구르트 함량 비율(Base Ratio %, 예: 70%)을 곱하여 베이스 요구르트 환산 무게를 구한 뒤, 원재료 투입 무게 대비 실제 수율을 정밀 산출합니다.' },
