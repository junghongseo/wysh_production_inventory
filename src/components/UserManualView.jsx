...
const UserManualView = () => {
  ...
  const manualData = useMemo(() => [
      ...
      content: [
        {
          ...
          items: [
            ...
            { term: '🖨️ [배합표 인쇄 / PDF]', desc: '선택한 생산 계획의 원재료 및 부재료 배합 비율표를 출력하거나 PDF로 저장합니다.' }
          ]
        },
        {
    ...
    },
    {
      ...
      categoryId: 'calendar',
      mode: 'admin',
      title: '👑 [관리자 전용] 생산 계획 수정 및 삭제 관리',
      summary: '관리자 권한으로 등록된 생산 계획을 변경하거나 삭제합니다.',
      tags: ['계획 수정', '계획 삭제', '관리자 권한', '배합표 수정'],
      content: [
        {
          heading: '🔘 주요 관리자 기능',
          items: [
