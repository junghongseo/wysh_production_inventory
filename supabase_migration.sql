...
-- =========================================================================
-- 5. Shipping Charts Table (Daily Official Shipping Chart Storage)
-- =========================================================================

CREATE TABLE IF NOT EXISTS shipping_charts (
    date DATE PRIMARY KEY,
    title TEXT NOT NULL,
    total_count INTEGER NOT NULL DEFAULT 0,
    product_totals JSONB NOT NULL DEFAULT '[]'::jsonb,
    results JSONB NOT NULL DEFAULT '[]'::jsonb,
    qty_breakdown JSONB NOT NULL DEFAULT '{}'::jsonb,
    remarks TEXT DEFAULT '',
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL
);

-- Enable RLS and add policies
ALTER TABLE shipping_charts ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Allow public read access to shipping_charts" ON shipping_charts FOR SELECT USING (true);
CREATE POLICY "Allow public write access to shipping_charts" ON shipping_charts FOR INSERT WITH CHECK (true);
